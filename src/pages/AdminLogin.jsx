...
import { ShieldCheck, Mail, Lock, AlertCircle, Info, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col px-4 py-16 sm:px-6">
      <div className="mb-6 flex flex-col items-center text-center">
        ...
        <p className="mt-1 text-sm text-muted-foreground">Restricted access — reviewers only.</p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="admin@rapidshield.demo"
            />
          </div>
        </div>
        <div>
      ...
      <div className="mt-4 rounded-xl border border-border bg-muted/40 p-4 text-sm">
        <p className="flex items-center gap-2 font-medium"><Info className="h-4 w-4 text-primary" /> Demo admin</p>
        <p className="mt-2 text-xs text-muted-foreground">Email: <span className="font-mono">admin@rapidshield.demo</span></p>
        <p className="text-xs text-muted-foreground">Password: <span className="font-mono">admin123</span></p>
      </div>

      <Link to="/" className="mt-4 inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-primary">
